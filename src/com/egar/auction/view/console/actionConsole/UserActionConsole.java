...
public class UserActionConsole {
    ...
    public void viewListUserGoods() {
        printList(authorizedUserController.listUserGoods(user));
    }
    ...
    public void viewListUserBids() {
        printList(authorizedUserController.listUserBids(user));
    }
    ...
    public void addGood() {
        ...
        try {
            ...
            authorizedUserController.addGood(category, nameGood, description, minPrice, maxPrice,user);
    ...
    public void makeBet() {
        try {
            ...
            authorizedUserController.makeBet(price, good,user);
    ...
    public void changeUserData() {
        ...
        authorizedUserController.changeUserData(name, password,user);
    }
