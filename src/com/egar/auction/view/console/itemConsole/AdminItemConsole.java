...
public class AdminItemConsole {
    ...
    public void show() {
        try {
            admin = connect();
            actionConsole = new AdminActionConsole(adminController, scanner, admin);
            System.out.println();
    ...
    private Admin connect() throws UserNotFoundException, UserException {
        System.out.println();
        System.out.println("Введите имя:");
        String name = scanner.next();
        System.out.println("Введите пароль:");
        String password = scanner.next();
        return adminController.connectToAdmin(name, password);
    }
